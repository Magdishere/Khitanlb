    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="breadcrumb-header justify-content-between">
                <div class="my-auto">
                    <div class="d-flex">
                        <h4 class="content-title mb-0 my-auto">Edit Coupon</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"> / Coupons</span>
                    </div>
                </div>
            </div>
            <!-- breadcrumb -->
                ...
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('admin-coupons.update', $coupon->id)}}" method="POST" class="form-sample" enctype="multipart/form-data">
                                @csrf
                                @if($coupon->exists)
                                    @method('PUT')
                                @endif
