        ...
        <div class="row mt-20">
            <div class="col-lg-12">
                <ul class="filter__controls">
                    <li class="active" data-filter=".best_sellers">Best Sellers</li>
...
{{--            </div>--}}
            <div class="col-lg-4">
                ...
                <div class="categories__deal__countdown">
                    ...
                    <a href="{{route('sale.product', ['id'=>$countdownSale->id])}}" class="primary-btn count-down-banner-btn" style="background-color: transparent;">Shop now</a>
                @else
